...
export default function ProductCTA() {
  return (
    <section className="relative w-full py-20 md:py-32 overflow-hidden bg-[#1c559d]">
      ...
      {/* Content */}
      <div className="mx-auto px-6 md:px-[70px] relative z-10 flex flex-col items-center text-center gap-8 md:gap-12">
        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold font-display text-white max-w-4xl leading-tight">
